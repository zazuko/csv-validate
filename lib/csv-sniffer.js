 ...
 *
 * License: MIT
 * Origin: https://github.com/MonetDBSolutions/npm-csv-sniffer
 */
...
function guessQuoteAndDelimiter (sample, newlineStr, delimiters) {
  ...
  matches.forEach(function (d) {
    if (Object.prototype.hasOwnProperty.call(d, 'delim') && (!delimiters || delimiters.indexOf(d.delim) > -1)) {
      if (!Object.prototype.hasOwnProperty.call(delimCounters, d.delim)) delimCounters[d.delim] = 1
      else ++delimCounters[d.delim]
    }
    if (Object.prototype.hasOwnProperty.call(d, 'quote')) {
      if (!Object.prototype.hasOwnProperty.call(quoteCounters, d.quote)) quoteCounters[d.quote] = 1
...
function guessDelimiter (sample, newlineStr, delimiters) {
  ...
  while ((newlinePos = sample.indexOf(newlineStr, curCharIndex)) > -1) {
    ...
    var ascii = []
    for (let i = 0; i < asciiMax - startAsciiAt; ++i) {
